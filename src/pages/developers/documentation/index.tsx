              ...
              <TabsContent value="getting-started" className="p-4 border rounded-lg mt-2">
                ...
                <div className="space-y-4">
                  <div className="border-b pb-4">
                    ...
                    <Link to="/developers/documentation/platform-overview" className="text-soundblue-500 font-medium hover:underline">Read More →</Link>
                  </div>
                  <div className="border-b pb-4">
                    ...
                    <Link to="/developers/documentation/quick-start" className="text-soundblue-500 font-medium hover:underline">Read More →</Link>
                  </div>
                  <div className="border-b pb-4">
                    ...
                    <Link to="/developers/documentation/account-setup" className="text-soundblue-500 font-medium hover:underline">Read More →</Link>
                  </div>
                  <div>
                    ...
                    <Link to="/developers/documentation/core-concepts" className="text-soundblue-500 font-medium hover:underline">Read More →</Link>
                  </div>
                </div>
              </TabsContent>
              <TabsContent value="apis" className="p-4 border rounded-lg mt-2">
                ...
                <div className="space-y-4">
                  <div className="border-b pb-4">
                    ...
                    <Link to="/developers/documentation/rest-api-reference" className="text-soundblue-500 font-medium hover:underline">Read More →</Link>
                  </div>
                  <div className="border-b pb-4">
                    ...
                    <Link to="/developers/documentation/ios-sdk" className="text-soundblue-500 font-medium hover:underline">Read More →</Link>
                  </div>
                  <div className="border-b pb-4">
                    ...
                    <Link to="/developers/documentation/android-sdk" className="text-soundblue-500 font-medium hover:underline">Read More →</Link>
                  </div>
                  <div>
                    ...
                    <Link to="/developers/documentation/web-sdk" className="text-soundblue-500 font-medium hover:underline">Read More →</Link>
                  </div>
                </div>
              </TabsContent>
              <TabsContent value="guides" className="p-4 border rounded-lg mt-2">
                ...
                <div className="space-y-4">
                  <div className="border-b pb-4">
                    ...
                    <Link to="/developers/documentation/voice-assistant-implementation" className="text-soundblue-500 font-medium hover:underline">Read More →</Link>
                  </div>
                  <div className="border-b pb-4">
                    ...
                    <Link to="/developers/documentation/custom-domain-creation" className="text-soundblue-500 font-medium hover:underline">Read More →</Link>
                  </div>
                  <div className="border-b pb-4">
                    ...
                    <Link to="/developers/documentation/performance-optimization" className="text-soundblue-500 font-medium hover:underline">Read More →</Link>
                  </div>
                  <div>
                    ...
                    <Link to="/developers/documentation/security-best-practices" className="text-soundblue-500 font-medium hover:underline">Read More →</Link>
                  </div>
                </div>
              </TabsContent>
            </Tabs>
